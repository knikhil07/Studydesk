        ...
        <div
          className={` ${
            Coursesidebar
              ...
              : " hidden "
          }  z-20  lg:flex lg:h-full lg:w-[20%] ${scrollDivBg ?"bg-white dark:bg-black" :"border-r-2"} dark:bg-black *:dark:text-white overflow-y-scroll dark:border-none `}
        >
          <div className="px-2 py-2 border-t-2 dark:border-none  w-full lg:hidden bg-white *:dark:fill-white  dark:bg-white/5 flex items-center *:cursor-pointer gap-3">
            <button
              ...
              className={`px-2 py-2 ml-3 rounded-full bg-black/5 dark:bg-white/5   transition-all ${
