    ...
    return (
        ...
        <div className="min-h-[90vh] p-6 w-screen grid place-content-center">
          <div className="max-w-7xl mx-auto px-4 flex flex-col items-center justify-center gap-4">
            <h2 className="text-3xl md:pt-44 font-semibold sm:text-4xl md:text-4xl lg:text-6xl">
              Learn and Gain
            </h2>
            <p className="px-6 flex mb-4 flex-wrap max-w-lg sm:max-w-2xl md:max-w-3xl lg:max-w-4xl ">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              return(
                <div
                key={index}
                className="p-6 rounded-lg bg-white shadow-md *:cursor-pointer grid place-items-center gap-3"
              >
                ...
                <div className="flex justify-between w-full">
                  ...
                  <button onClick={()=>{nav(`/${index}/${item.list}`)}} className="px-6 py-2 text-sky-500">Visit </button>
                </div>
              </div>
              );
              })}
