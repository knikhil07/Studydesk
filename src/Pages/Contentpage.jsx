              ...
              (item, index) => (
                <React.Fragment key={index}>
                 ...
                 {item?.defination?.map((item,index)=>{
                  return(
                    <div key={index} className="w-[90%] pl-3 md:pl-8 lg:pl-10 gap-3 flex flex-col items-start">
                        <b>{item.b}</b>
                        <div className="flex flex-col gap-3 ">
                  ...
                  <div className="px-6 py-8 w-[90%] min-w-72 shadow-md bg-slate-800 rounded-xl">
                    <div>
                      <h1 className="text-2xl font-bold mb-3 text-sky-500">
                        {item.head ? item.head + " Syntax" : item.attri}
                      </h1>
...
{item?.exampleCode?  <div className="px-6 py-8 w-[90%] min-w-72 shadow-md bg-slate-800 rounded-xl">
                    <div>
                      <h1 className="text-2xl font-bold mb-3 text-sky-500">
                        Example Code
                      </h1>
